defmodule LiveCampaignSentiment do
  use Application
  ...
  def start(_type, _args) do
    ...
    opts = [strategy: :one_for_one, name: LiveCampaignSentiment.Supervisor]
  ...
  def config_change(changed, _new, removed) do
    LiveCampaignSentiment.Endpoint.config_change(changed, removed)
    :ok
  end
end
